...
local status, windowMappings = pcall(require, 'window-layout-mode.windows-bindings')

if not status then
  windowMappings = require('window-layout-mode.windows-bindings-defaults')
end
...
local message = require('window-layout-mode.status-message')
